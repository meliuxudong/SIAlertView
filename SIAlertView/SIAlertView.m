...
- (CGFloat)heightForTitleLabel
{
    if (self.titleLabel) {
        ...
        CGFloat height = [self.title boundingRectWithSize:CGSizeMake(CONTAINER_WIDTH - CONTENT_PADDING_LEFT * 2, [self.title sizeWithAttributes:@{NSFontAttributeName:self.titleLabel.font}].height) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:self.titleLabel.font} context:nil].size.height;
...
- (CGFloat)heightForMessageLabel
{
    ...
    if (self.messageLabel) {
        ...
        CGFloat height = [self.message boundingRectWithSize:CGSizeMake(CONTAINER_WIDTH - CONTENT_PADDING_LEFT * 2, maxHeight) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:self.messageLabel.font} context:nil].size.height;
